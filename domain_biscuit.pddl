...
(define (domain coffee_robot)
    ...
    (:action Biscuit_Prepare ; initial action
    ...
    (:action Pick_up_biscuit
        :parameters (?bis -biscuit ?r -robot ?t -table)
        :precondition (and (waiter ?r) (robot_pos ?r ?t) (or (and (not (holding_tray ?r)) (= (holding ?r ) 0)) (and (holding_tray ?r) (< (holding ?r) 3))) (biscuit_on_table ?bis ?t) (>= (tim ?r) 100))
        :effect (and (increase (holding ?r) 1) (biscuit_holded ?bis ?r) (not (biscuit_on_table ?bis ?t)))
    )
...
>>>>>>> 1d29125696f27cdb96b62066967a3b5f49aef906
    (:event Cleaned
        :parameters (?r -robot ?t -table)
